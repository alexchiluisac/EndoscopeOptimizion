...
earModel.baseTransform = eye(4);

% Create a robot
alpha = pi/2;
cutouts = [];
cutouts.w = [1 1 1 1 1 1 1 1 1];
cutouts.u = [1 1 1 1 1 1 1 1 1];
cutouts.h = [1 1 1 1 1 1 1 1 1];
cutouts.alpha = [0 0 0 alpha 0 0 alpha 0 0 0];
robot = Wrist(1.6, 1.85, 9, cutouts);
